...
def update_password_data_type(database_path):
    try:
        ...
        cursor.execute("CREATE TABLE Users (Id INTEGER PRIMARY KEY, Username VARCHAR(50) UNIQUE NOT NULL, Password TEXT NOT NULL);")
        cursor.execute("INSERT INTO Users (Id, Username, Password) SELECT Id, Username, Password FROM Users_backup;")
